...
alias nvimup='curl -LO https://github.com/neovim/neovim/releases/latest/download/nvim-linux-x86_64.tar.gz && sudo rm -rf /opt/nvim-linux-x86_64 && sudo tar -C /opt -xzf nvim-linux-x86_64.tar.gz'
...
alias cdfrwr='cd ~/Projects/fr/bonprix-www/translations/'
...
alias cdplwr='cd ~/Projects/pl/bonprix-www/translations/'
...
alias rse='service_restart dev/se'
...
alias use='service_up dev/se'
alias usep='service_up dev/se/local'
...
alias dpsse='docker ps -f "name=bonprix-dev-se-nginx-ssr"'
