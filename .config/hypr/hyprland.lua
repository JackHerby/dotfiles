...
-- hl.bind(mainMod .. " + M",   hl.dsp.exec_cmd("hyprctl dispatch layoutmsg moveroot")) -- dwindle
...
hl.bind(mainMod .. " + CTRL + down", hl.dsp.window.resize({ x = 0, y = 8 }))
hl.bind(mainMod .. " + CTRL + left", hl.dsp.window.resize({ x = -8, y = 0 }))
hl.bind(mainMod .. " + CTRL + right", hl.dsp.window.resize({ x = 8, y = 0 }))
hl.bind(mainMod .. " + CTRL + up", hl.dsp.window.resize({ x = 0, y = -8 }))
